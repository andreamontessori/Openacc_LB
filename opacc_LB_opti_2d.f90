...
!#endif
    ...
    !do ll=0,nlinks
    f0(1:nx,1:ny,1:2)=0.0_db
    f1(1:nx,1:ny,1:2)=0.0_db
    f2(1:nx,1:ny,1:2)=0.0_db
    f3(1:nx,1:ny,1:2)=0.0_db
    f4(1:nx,1:ny,1:2)=0.0_db
    f5(1:nx,1:ny,1:2)=0.0_db
    f6(1:nx,1:ny,1:2)=0.0_db
    f7(1:nx,1:ny,1:2)=0.0_db
    f8(1:nx,1:ny,1:2)=0.0_db
    nsp=1
    nsk=2
    !enddo
    !*************************************check data ************************ 
