#include "defines.h"
 module streamcoll_bulk_kernels
  ...
  attributes(global) subroutine streamcoll_bulk_k(k)
	...
	i = (blockIdx%x-1) * TILE_DIMx_k_d + threadIdx%x
	j = (blockIdx%y-1) * TILE_DIMy_k_d + threadIdx%y
  ...
  end subroutine streamcoll_bulk_k
  
  attributes(global) subroutine streamcoll_bulk01()
  ...
  end subroutine streamcoll_bulk01
  
    attributes(global) subroutine streamcoll_bulk012xy()
	...
	real(kind=db) :: uu,udotc,temp
	real(kind=db) :: temp_pop,temp_rho,temp_u,temp_v,temp_w
	real(kind=db) :: temp_pxx,temp_pyy,temp_pxy
#ifdef USESHARE 
    integer :: li,lj,lk
	real(kind=db), shared :: loc_rho(0:TILE_DIMx_d+1,0:TILE_DIMy_d+1,0:TILE_DIMz_d+1)
#endif
  ...
  end subroutine streamcoll_bulk012xy
  
  attributes(global) subroutine streamcoll_bulk012xz()
	...
	real(kind=db) :: uu,udotc,temp
	real(kind=db) :: temp_pop,temp_rho,temp_u,temp_v,temp_w
	real(kind=db) :: temp_pxx,temp_pzz,temp_pxz
#ifdef USESHARE 
    integer :: li,lj,lk
	real(kind=db), shared :: loc_rho(0:TILE_DIMx_d+1,0:TILE_DIMy_d+1,0:TILE_DIMz_d+1)
#endif
  ...
  end subroutine streamcoll_bulk012xz
  
  attributes(global) subroutine streamcoll_bulk012yz()
  ...
  end subroutine streamcoll_bulk012yz
  
  attributes(global) subroutine streamcoll_bulk2()
  ...
  end subroutine streamcoll_bulk2
  
  attributes(global) subroutine streamcoll_bulk2xy()
  ...
  end subroutine streamcoll_bulk2xy
  
  attributes(global) subroutine streamcoll_bulk2xz()
  ...
  end subroutine streamcoll_bulk2xz
  
  attributes(global) subroutine streamcoll_bulk2yz()
  ...
  end subroutine streamcoll_bulk2yz
  ...
  attributes(global) subroutine streamcoll_bulk_flop_k(k)
  ...
  end subroutine streamcoll_bulk_flop_k
